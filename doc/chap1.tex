...
\end{equation}
Poprzez zastosowanie cepstrum sygnału mowy otrzymujemy więc rozdzielenie komponentów pochodzących od funkcji $h_1(t)$ i $h_2(t)$. Proces zobrazowany jest na rysunku \%TODO RYSUNEK. Niskie współczynniki cepstrum opisują charakterysytkę aparatu głosowego, zaś widoczny w okolicach \% OPISAĆ RYSUNEK.
