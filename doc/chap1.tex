...
\begin{equation}
  \tilde{H}_j = \sum_{k=1}^{K} H_k \cdot {}^jF_k, \quad k \in {1...N}, \quad  j \in {1...M}
\end{equation}
gdzie $\tilde{H}_j$ oznacza $j$-ty współczynnik amplitudy widma w dziedzinie częstotliwości Mela, ${}^jF_k$ współczynniki $j$-tego filtru, zaś $M$ oznacza liczbę filtrów.
