...
\begin{enumerate}
  ...
  \item $c_d = \alpha_d + \sum_{i=1}^{d-1} c_j a_{d-i} \quad \textrm{\textbf{dla}} \quad 1\leq d \leq p$
  \item $c_d = \sum_{i=1}d + \sum_{i=1}^{d-1} c_j a_{d-i} \quad \textrm{\textbf{dla}} \quad d > p$
