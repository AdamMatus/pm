...
std::array<std::array<double, K>, C> vq::lbg(const std::vector<std::array<double, K>>& acoustic_vectors)  
{
...
template<int K>
double vq::dis_eu(const std::array<double, K>& v1, const std::array<double, K>& v2)
{
  double dist =0;
